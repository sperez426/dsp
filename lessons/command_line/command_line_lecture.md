...
> Question: How could we make sure that we moved? pwd
...
> Hint: we learned how to list all the files up above. ls
...
would we do that? echo https://archive.ics.uci.edu/ml/machine-learning-databases/auto-mpg/auto-mpg.data > data.txt
...
> What changed? added the letter B (for bytes) next to the file sizes
